...
export interface ApiConstructionStepConstructionStep
  extends Struct.CollectionTypeSchema {
  collectionName: 'construction_steps';
  info: {
    displayName: 'CONSTRUCTION_STEPS';
    pluralName: 'construction-steps';
    singularName: 'construction-step';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::construction-step.construction-step'
    > &
      Schema.Attribute.Private;
...
export interface ApiFinalCtaDataFinalCtaData
  extends Struct.CollectionTypeSchema {
  collectionName: 'final_cta_datas';
  info: {
    displayName: 'FINAL_CTA_DATA';
    pluralName: 'final-cta-datas';
    singularName: 'final-cta-data';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.String;
    icons: Schema.Attribute.Component<'shared.icons', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::final-cta-data.final-cta-data'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
...
export interface ApiFloorPlanFloorPlan extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    config: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiLifestyleLifestyle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    desc: Schema.Attribute.Text;
    FloatingCardPr: Schema.Attribute.String;
    FloatingCardText: Schema.Attribute.String;
    icon: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiLocationAdvantageLocationAdvantage
  extends Struct.CollectionTypeSchema {
  collectionName: 'location_advantages';
  info: {
    displayName: 'LOCATION_ADVANTAGES';
    pluralName: 'location-advantages';
    singularName: 'location-advantage';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::location-advantage.location-advantage'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiMasterPlanMasterPlan extends Struct.CollectionTypeSchema {
  collectionName: 'master_plans';
  info: {
    displayName: 'MASTER_PLAN';
    pluralName: 'master-plans';
    singularName: 'master-plan';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::master-plan.master-plan'
    > &
      Schema.Attribute.Private;
    MASTER_PLAN_IMAGE: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPiramalStatPiramalStat extends Struct.CollectionTypeSchema {
  collectionName: 'piramal_stats';
  info: {
    displayName: 'PIRAMAL_STATS';
    pluralName: 'piramal-stats';
    singularName: 'piramal-stat';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPricingPricing extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    carpetArea: Schema.Attribute.String;
    config: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    possession: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    rera: Schema.Attribute.String;
...
export interface ApiWhyInvestThaneWhyInvestThane
  extends Struct.CollectionTypeSchema {
  collectionName: 'why_invest_thanes';
  info: {
    displayName: 'WHY_INVEST_THANE';
    pluralName: 'why-invest-thanes';
    singularName: 'why-invest-thane';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::why-invest-thane.why-invest-thane'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::construction-step.construction-step': ApiConstructionStepConstructionStep;
      'api::faq.faq': ApiFaqFaq;
      'api::final-cta-data.final-cta-data': ApiFinalCtaDataFinalCtaData;
      ...
      'api::location-advantage.location-advantage': ApiLocationAdvantageLocationAdvantage;
      'api::master-plan.master-plan': ApiMasterPlanMasterPlan;
      'api::nav-link.nav-link': ApiNavLinkNavLink;
      'api::piramal-stat.piramal-stat': ApiPiramalStatPiramalStat;
      ...
      'api::why-invest-thane.why-invest-thane': ApiWhyInvestThaneWhyInvestThane;
